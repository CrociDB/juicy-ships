...
Shader "Juicy/GeneralObject"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Specular = ( _Color + ( ( dotResult50 * 1.4 ) * float4(1,1,1,1) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=11001
428;135;1352;702;2042.598;-149.9998;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1418.676,551.3813;Float;False;Constant;_Float6;Float 6;7;0;1.4;0;0;0;1;FLOAT
...
ASEEND*/
//CHKSM=097ABC8A8A735A31D5624488E5F16F308DE2F09C